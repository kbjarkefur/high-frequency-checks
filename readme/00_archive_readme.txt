...
Add additional sub-folders in order to organize files. You might also want to create an individual "archive" folder inside each sub-folder to facilitate sub-categorization.
